    ...
    public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        switch (newString){
            ...
            case "vegetarian":
                ...
                break;
            case "wrong":
                context.getSource().sendSuccess(new TextComponent(ChatFormatting.BOLD + "-=Wrong=-"), false);
                context.getSource().sendSuccess(new TranslatableComponent("check.villainousdifficultymultipliers.wrong"), false);
                break;
            case "celebration":
            ...
            case "rested":
                ...
                break;
            case "wild":
                context.getSource().sendSuccess(new TextComponent(ChatFormatting.BOLD + "-=Wild=-"), false);
                context.getSource().sendSuccess(new TranslatableComponent("check.villainousdifficultymultipliers.wild"), false);
                break;
            case "pandemic":
                ...
                context.getSource().sendSuccess(new TranslatableComponent("check.villainousdifficultymultipliers.pandemic"), false);
                break;
            default:
