...
public class activeListCommand implements Command<CommandSource> {
    ...
    public int run(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        AtomicReference<String> string = new AtomicReference<>("");
            ...
            if(VDM.config.ANGER.get()) {string.set(string.get() + "Anger, "); count.set(count.get()+1);}
            ...
            if(VDM.config.UNSTABLE.get()) {string.set(string.get() + "Unstable, "); count.set(count.get()+1);}
